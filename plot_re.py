...
def pl(result_list, result_list2):
    plt.figure('Proposed_test_acc', figsize=(14, 5))

    plt.subplot(1, 2, 1)
    plt.title('i.i.d case')
    markevery = 10
    markersize = 6
    plt.plot(range(len(result_list[0]['test_acc'])), result_list[0]['test_acc'] / 100.,
             label=r'Proposed SCA-based Algorithm', color='#1f77b4', marker='o', markevery=markevery,
             markersize=markersize,
             markerfacecolor='none')
    plt.plot(range(len(result_list[2]['test_acc'])), result_list[2]['test_acc'] / 100.,
             label=r'Aligned-Noiseless Aggregation', color='#2ca02c', linestyle='--')
    plt.plot(range(len(result_list[3]['test_acc'])), result_list[3]['test_acc'] / 100.,
             label=r'Aligned-Sample Estimator', color='#d62728', marker='s', markevery=markevery, markersize=markersize,
             markerfacecolor='none')
    plt.plot(range(len(result_list2[4]['test_acc'])), result_list2[4]['test_acc'] / 100.,
             label=r'OFDMA', color='black', markevery=markevery, markersize=markersize,
             markerfacecolor='none')
    plt.plot(range(len(result_list[1]['test_acc'])), result_list[1]['test_acc'] / 100.,
    ...
    plt.subplot(1, 2, 2)
    plt.title('non-i.i.d case')
    markevery = 10
    markersize = 6
    plt.plot(range(len(result_list2[0]['test_acc'])), result_list2[0]['test_acc'] / 100.,
             label=r'Proposed SCA-based Algorithm', color='#1f77b4', marker='o', markevery=markevery,
             markersize=markersize,
             markerfacecolor='none')
    plt.plot(range(len(result_list2[2]['test_acc'])), result_list2[2]['test_acc'] / 100.,
             label=r'Aligned-Noiseless Aggregation', color='#2ca02c', linestyle='--')
    plt.plot(range(len(result_list2[3]['test_acc'])), result_list2[3]['test_acc'] / 100.,
             label=r'Aligned-Sample Estimator', color='#d62728', marker='s', markevery=markevery, markersize=markersize,
             markerfacecolor='none')
    plt.plot(range(len(result_list2[4]['test_acc'])), result_list2[4]['test_acc'] / 100.,
             label=r'OFDMA', color='black', markevery=markevery, markersize=markersize,
             markerfacecolor='none')
    plt.plot(range(len(result_list2[1]['test_acc'])), result_list2[1]['test_acc'] / 100.,
             label=r'ML Estimator', color='#ff7f0e', marker='*', markevery=markevery, markersize=8)
    label_font = {
        'family': 'Arial',  # 字体
        'style': 'normal',
...
if __name__ == '__main__':
    ...
    if E == 1:  # ---------------- IID ---------------------------
        ...
        filename2 = f'./store_fullbatch/_M_{args.M_Prime}_N_{args.N}_EsN0dB_{-26.0}_epoch_{args.epochs}_lr_{args.lr}_02_mnist_iid.npz'
        ...
        filename5 = f'./store_fullbatch/_M_{args.M_Prime}_N_{args.N}_EsN0dB_{-26.0}_epoch_{args.epochs}_lr_{args.lr}_05_mnist_iid.npz'
    else:
        ...
        filename5 = f'./store_fullbatch/mnist_1/_M_{args.M_Prime}_N_{args.N}_EsN0dB_{args.EsN0dB}_epoch_{args.epochs}_lr_{args.lr}_05_mnist_iid.npz'
    ...
    if E == 1:  # ---------------- non-IID ---------------------------
        ...
        filename5 = f'./store_fullbatch/_M_{args.M_Prime}_N_{args.N}_EsN0dB_{-20.0}_epoch_{args.epochs}_lr_{args.lr}_05_mnist_niid.npz'
    else:
        ...
        filename5 = f'./store_fullbatch/mnist_1/_M_{args.M_Prime}_N_{args.N}_EsN0dB_{args.EsN0dB}_epoch_{args.epochs}_lr_{args.lr}_05_mnist_niid.npz'
